            ...
            <div className="container max-w-4xl bg-slate-50 rounded-lg my-4">
              <div className="flex flex-col justify-start items-center my-4">
                ...
                <div className="flex flex-wrap justify-start items-center gap-2 ml-10 mr-8 mb-8 mt-10">
                  ...
                  <div className="flex flex-col justify-start items-center gap-2 mb-auto w-full md:w-auto">
                    ...
                    <div className="flex flex-row justify-center gap-6">
                      ...
                      <a href="https://line.me/ti/p/~gotawa_aryo" rel="noopener noreferrer" target={'_blank'}>
                        <svg className="w-12 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  ...
                  <div className="w-full md:w-auto flex">
                    <svg className="w-6 mx-auto md:mx-2 text-gray-800 text-center my-auto rotate-90 md:rotate-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
