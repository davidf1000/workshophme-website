...
export abstract class IQuery {
  abstract admins():
    | Nullable<AdminResponse>[]
    | Promise<Nullable<AdminResponse>[]>;

  abstract admin(
    id: number,
  ): Nullable<AdminResponse> | Promise<Nullable<AdminResponse>>;
...
export abstract class IMutation {
  ...
  abstract removeArticle(
    id: number,
  ): Nullable<Article> | Promise<Nullable<Article>>;

  abstract login(
    createLoginInput: LoginAdminInput,
  ): LoginAdminResponse | Promise<LoginAdminResponse>;
